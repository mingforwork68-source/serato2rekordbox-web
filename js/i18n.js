...
window.S2R_DICT = {
  "zh-Hant": {
    ...
    "faq.q6.p1": `回到<a href="index.html">轉換工具首頁</a>,下方步驟⑤有完整的圖文教學(含截圖),照著操作即可。`,
  ...
  "zh-Hans": {
    ...
    "faq.q6.p1": `回到<a href="index.html">转换工具首页</a>,下方步骤⑤有完整的图文教学(含截图),照着操作即可。`,
  ...
  "en": {
    ...
    "faq.q6.p1": `Go back to the <a href="index.html">converter homepage</a> — step ⑤ has a full walkthrough with screenshots.`,
